...
// KRİTİK DEĞİŞİKLİK: SQL Server yerine PostgreSQL kullanılıyor
...
[DependsOn(
    ...
    // KRİTİK DEĞİŞİKLİK: SQL Server Modülü kaldırıldı, PostgreSQL Modülü eklendi
...
public class BankAppAuthServerModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            dataProtectionBuilder.PersistKeysToStackExchangeRedis(redis, "BankApp-Protection-Keys");
        }
