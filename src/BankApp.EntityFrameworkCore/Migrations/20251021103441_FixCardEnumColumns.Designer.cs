...
namespace BankApp.Migrations
{
    ...
    [Migration("20251021103441_FixCardEnumColumns")]
    partial class FixCardEnumColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankApp.Domain.Lookups.CardStatusLookup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("CardStatusLookups", "bankapp");
                });

            modelBuilder.Entity("BankApp.Domain.Lookups.CardTypeLookup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CardTypeLookups", "bankapp");
                });

            modelBuilder.Entity("BankApp.Domain.Lookups.TransactionTypeLookup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TransactionTypeLookups", "bankapp");
                });
            ...
            modelBuilder.Entity("BankApp.Entities.Card", b =>
                {
                    ...
                    b.ToTable("Cards", "bankapp", t =>
                        {
                            t.Property("CardTypeId")
                                .HasColumnName("CardTypeId1");
            ...
            modelBuilder.Entity("BankApp.Entities.Customer", b =>
                {
                    ...
                    b.ToTable("Customers", "bankapp");
                });

            modelBuilder.Entity("BankApp.Entities.GeneralLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BankApp.Entities.Transaction", b =>
                {
                    ...
                    b.ToTable("Transactions", "bankapp", t =>
                        {
            ...
            modelBuilder.Entity("BankApp.Entities.Card", b =>
                {
                    b.HasOne("BankApp.Domain.Lookups.CardTypeLookup", null)
                        .WithMany()
                        .HasForeignKey("CardTypeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BankApp.Domain.Lookups.CardStatusLookup", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BankApp.Entities.Transaction", b =>
                {
                    b.HasOne("BankApp.Domain.Lookups.TransactionTypeLookup", null)
                        .WithMany()
